...
namespace Microsoft.SharePoint.Client.NetCore
{
    ...
    public sealed class InformationRightsManagementSettings : ClientObject
    {
        ...
        public DateTime DocumentLibraryProtectionExpireDate
        {
            ...
            set
            {
                base.ObjectData.Properties["DocumentLibraryProtectionExpireDate"] = value;
                if (base.Context != null)
                {
                    base.Context.AddQuery(new ClientActionSetProperty(this, "DocumentLibraryProtectionExpireDate", value));
                }
            }
        }
        ...
        public InformationRightsManagementSettings(ClientRuntimeContext context, ObjectPath objectPath) : base(context, objectPath)
        {
        }
